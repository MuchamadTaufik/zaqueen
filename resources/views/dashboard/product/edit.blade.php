...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/product/{{ $product->slug }}" class="mb-3" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('material') is-invalid @enderror" id="material" name="material" required value="{{ old('material', $product->material) }}">
                @error('material')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('size') is-invalid @enderror" id="size" name="size" required value="{{ old('size', $product->size) }}">
                @error('size')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-2">
                ...
                @if ($product->image1)
                    <img src="{{ asset('storage/' . $product->image1) }}" class="img-preview img-fluid mb-3 d-block" id="frame" style="max-height: 400px; overflow:hidden">
                @else
            ...
            <div class="mb-2">
                ...
                @if ($product->image2)
                    <img src="{{ asset('storage/' . $product->image2) }}" class="img-preview img-fluid mb-3 d-block" id="frame2" style="max-height: 400px; overflow:hidden">
                @else
            ...
            <div class="mb-2">
                ...
                @if ($product->image3)
                    <img src="{{ asset('storage/' . $product->image3) }}" class="img-preview img-fluid mb-3 d-block" id="frame3" style="max-height: 400px; overflow:hidden">
                @else
